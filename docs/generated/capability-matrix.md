...
| agent | plan-validator | @plan-validator | active | plan-artifact-write, contract-drift | @artifact-planner for domain-level plan changes |
...
| skill | opencode-plan-validator | @plan-validator | active | plan-artifact-write, contract-drift | @artifact-planner for non-mechanical plan changes |
