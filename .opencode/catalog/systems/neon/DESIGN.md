...
> Vibe: Dark ground with neon accent. Glow effects, sharp type, high-contrast, futuristic.

> **Source**: https://open-design.ai/plugins/systems/example-neon
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download neon`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug neon`.

---

## 1. Visual Theme & Atmosphere

Neon's futuristic discipline: dark ground, glow effects, sharp type, high-contrast.

This system commits to futuristic glow. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#ffffff`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#00ffff`): Action color, focus, primary CTA, selected state.
- **Surface** (`#0a0a0a`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#666666`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#1a1a1a`): Hover, disabled, inactive.

### Semantic
- **Success** (`#00ff00`): Confirmations, positive deltas.
- **Warning** (`#ffaa00`): Caution, recoverable errors.
- **Danger** (`#ff0055`): Destructive actions, errors, critical alerts.
- **Info** (`#00ffff`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#000000`): For primary surfaces.
- **Dark ink** (`#00ffff`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Orbitron | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Rajdhani | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Rajdhani | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Rajdhani | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Rajdhani | 20/28 | 600 | 1.25 | 0 |
| Body Large | Rajdhani | 18/28 | 400 | 1.55 | 0 |
| Body | Rajdhani | 16/24 | 400 | 1.5 | 0 |
| Small | Rajdhani | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Rajdhani | 12/16 | 500 | 1.35 | 0.02em |
| Mono | Share Tech Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: futuristic glow means dark + glow, sharp type.
...
- **Photo style**: abstract
- **Illustration style**: neon glow
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-neon
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base neon`.
