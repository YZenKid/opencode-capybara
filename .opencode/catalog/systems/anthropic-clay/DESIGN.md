# Design System: Anthropic Clay

> Category: Morphe & Effects
> Surface: web | mobile | both
> Vibe: Claymorphism. Soft tactile rounded surfaces, layered shadows, warm pastels, gentle highlights.

> **Source**: https://open-design.ai/plugins/systems/example-anthropic-clay
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download anthropic-clay`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug anthropic-clay`.

---

## 1. Visual Theme & Atmosphere

Claymorphism's tactile discipline: soft rounded surfaces, layered shadows, warm pastels.

This system commits to tactile warm. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#3d2e26`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#d4a373`): Action color, focus, primary CTA, selected state.
- **Surface** (`#f5e6d3`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#a89888`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#ede0d0`): Hover, disabled, inactive.

### Semantic
- **Success** (`#7d9b76`): Confirmations, positive deltas.
- **Warning** (`#d4a373`): Caution, recoverable errors.
- **Danger** (`#c27070`): Destructive actions, errors, critical alerts.
- **Info** (`#a8b8c8`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#3d2e26`): For optional surfaces.
- **Dark ink** (`#f5e6d3`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Fraunces | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Nunito | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Nunito | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Nunito | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Nunito | 20/28 | 600 | 1.25 | 0 |
| Body Large | Nunito | 18/28 | 400 | 1.55 | 0 |
| Body | Nunito | 16/24 | 400 | 1.5 | 0 |
| Small | Nunito | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Nunito | 12/16 | 500 | 1.35 | 0.02em |
...
4. Match the system's vibe: tactile warm means soft tactile, layered.
...
- **Photo style**: warm lifestyle
- **Illustration style**: clay 3D
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-anthropic-clay
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base anthropic-clay`.
