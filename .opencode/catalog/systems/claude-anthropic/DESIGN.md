...
> Vibe: Anthropic Claude. Warm terracotta accent, cream ground, editorial serif, calm density.

> **Source**: https://open-design.ai/plugins/systems/example-claude-anthropic
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download claude-anthropic`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug claude-anthropic`.

---

## 1. Visual Theme & Atmosphere

Anthropic's warm-editorial discipline: terracotta accent on cream ground, serif headlines, calm density.

This system commits to warm editorial. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#2c1f1a`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#cc785c`): Action color, focus, primary CTA, selected state.
- **Surface** (`#faf9f5`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#8a7e74`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#f0ebe3`): Hover, disabled, inactive.

### Semantic
- **Success** (`#4a7c59`): Confirmations, positive deltas.
- **Warning** (`#b8860b`): Caution, recoverable errors.
- **Danger** (`#b34c4c`): Destructive actions, errors, critical alerts.
- **Info** (`#cc785c`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#262624`): For optional surfaces.
- **Dark ink** (`#faf9f5`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Tiempos Headline | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Styrene / Soehne | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Styrene / Soehne | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Styrene / Soehne | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Styrene / Soehne | 20/28 | 600 | 1.25 | 0 |
| Body Large | Styrene / Soehne | 18/28 | 400 | 1.55 | 0 |
| Body | Styrene / Soehne | 16/24 | 400 | 1.5 | 0 |
| Small | Styrene / Soehne | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Styrene / Soehne | 12/16 | 500 | 1.35 | 0.02em |
| Mono | Tiempos Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: warm editorial means terracotta + cream, calm.
...
- **Photo style**: warm editorial
- **Illustration style**: minimal line
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-claude-anthropic
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base claude-anthropic`.
