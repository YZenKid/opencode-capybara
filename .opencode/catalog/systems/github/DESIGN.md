...
> Vibe: GitHub Primer. Dark-first, dense data tables, octicons, functional density, blue accent.

> **Source**: https://open-design.ai/plugins/systems/example-github
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download github`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug github`.

---

## 1. Visual Theme & Atmosphere

GitHub's data-density discipline: tables, code, and chrome that disappears when not needed.

This system commits to dense functional. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#1f2328`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#0969da`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffffff`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#59636e`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#f6f8fa`): Hover, disabled, inactive.

### Semantic
- **Success** (`#1a7f37`): Confirmations, positive deltas.
- **Warning** (`#9a6700`): Caution, recoverable errors.
- **Danger** (`#d1242f`): Destructive actions, errors, critical alerts.
- **Info** (`#0969da`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#0d1117`): For primary surfaces.
- **Dark ink** (`#f0f6fc`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Inter | 56/64 | 700 | 1.05 | -0.02em |
...
4. Match the system's vibe: dense functional means data-dense, no decoration.
...
- **Photo style**: documentation-first
- **Illustration style**: octicons
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-github
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base github`.
