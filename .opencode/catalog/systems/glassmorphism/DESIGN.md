...
> Vibe: Frosted translucent glass overlays, blurred backgrounds, layered depth, soft borders.

> **Source**: https://open-design.ai/plugins/systems/example-glassmorphism
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download glassmorphism`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug glassmorphism`.

---

## 1. Visual Theme & Atmosphere

Glassmorphism's depth discipline: frosted overlays, blurred backgrounds, layered depth.

This system commits to frosted depth. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#0f172a`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#60a5fa`): Action color, focus, primary CTA, selected state.
- **Surface** (`#f1f5f9`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#94a3b8`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#e2e8f0`): Hover, disabled, inactive.

### Semantic
- **Success** (`#34d399`): Confirmations, positive deltas.
- **Warning** (`#fbbf24`): Caution, recoverable errors.
- **Danger** (`#f87171`): Destructive actions, errors, critical alerts.
- **Info** (`#60a5fa`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#0f172a`): For primary surfaces.
- **Dark ink** (`#f8fafc`): Primary text on dark ground.
...
4. Match the system's vibe: frosted depth means translucent, layered.
...
- **Photo style**: abstract gradient
- **Illustration style**: glass 3D
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-glassmorphism
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base glassmorphism`.
