...
> Vibe: Raw, anti-design, harsh layouts, thick black borders, monospace body, exposed structure.

> **Source**: https://open-design.ai/plugins/systems/example-brutalism
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download brutalism`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug brutalism`.

---

## 1. Visual Theme & Atmosphere

Brutalism's anti-design discipline: exposed structure, thick borders, monospace body.

This system commits to raw anti-design. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#000000`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#ff0000`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffffff`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#000000`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#f0f0f0`): Hover, disabled, inactive.

### Semantic
- **Success** (`#00ff00`): Confirmations, positive deltas.
- **Warning** (`#ffff00`): Caution, recoverable errors.
- **Danger** (`#ff0000`): Destructive actions, errors, critical alerts.
- **Info** (`#0000ff`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#ffffff`): For optional surfaces.
- **Dark ink** (`#000000`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Space Mono | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Space Mono | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Space Mono | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Space Mono | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Space Mono | 20/28 | 600 | 1.25 | 0 |
| Body Large | Space Mono | 18/28 | 400 | 1.55 | 0 |
| Body | Space Mono | 16/24 | 400 | 1.5 | 0 |
| Small | Space Mono | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Space Mono | 12/16 | 500 | 1.35 | 0.02em |
| Mono | Space Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: raw anti-design means harsh, exposed, monospace.
...
- **Photo style**: raw
- **Illustration style**: exposed structure
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-brutalism
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base brutalism`.
