...
> Vibe: Tesla. Radical subtraction, full-viewport photography, near-zero UI, minimal chrome.

> **Source**: https://open-design.ai/plugins/systems/example-tesla
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download tesla`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug tesla`.

---

## 1. Visual Theme & Atmosphere

Tesla's radical-subtraction discipline: full-viewport photography, near-zero UI chrome.

This system commits to radical subtraction. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#000000`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#cc0000`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffffff`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#393c41`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#f4f4f4`): Hover, disabled, inactive.

### Semantic
- **Success** (`#12b76a`): Confirmations, positive deltas.
- **Warning** (`#f79009`): Caution, recoverable errors.
- **Danger** (`#cc0000`): Destructive actions, errors, critical alerts.
- **Info** (`#1570ef`): Tips, non-blocking notices.
...
|---|---|---|---|---|---|
| Display | Gotham | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Gotham | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Gotham | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Gotham | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Gotham | 20/28 | 600 | 1.25 | 0 |
| Body Large | Gotham | 18/28 | 400 | 1.55 | 0 |
| Body | Gotham | 16/24 | 400 | 1.5 | 0 |
| Small | Gotham | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Gotham | 12/16 | 500 | 1.35 | 0.02em |
| Mono | Gotham Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: radical subtraction means full-bleed photo, near-zero UI.
...
- **Photo style**: full-viewport photography
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-tesla
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base tesla`.
