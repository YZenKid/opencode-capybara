...
> Vibe: Apple Human Interface Guidelines. SF Pro, dynamic color, generous spacing, native motion.

> **Source**: https://open-design.ai/plugins/systems/example-apple-hig
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download apple-hig`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug apple-hig`.

---

## 1. Visual Theme & Atmosphere

Apple's HIG discipline: native gestures, native chrome, native motion. Never web-port.

This system commits to native Apple. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#000000`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#007aff`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffffff`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#8e8e93`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#f2f2f7`): Hover, disabled, inactive.

### Semantic
- **Success** (`#34c759`): Confirmations, positive deltas.
- **Warning** (`#ff9500`): Caution, recoverable errors.
- **Danger** (`#ff3b30`): Destructive actions, errors, critical alerts.
- **Info** (`#5ac8fa`): Tips, non-blocking notices.
...
|---|---|---|---|---|---|
| Display | SF Pro Display | 56/64 | 700 | 1.05 | -0.02em |
| H1 | SF Pro Text | 40/48 | 700 | 1.1 | -0.015em |
| H2 | SF Pro Text | 32/40 | 700 | 1.15 | -0.01em |
| H3 | SF Pro Text | 24/32 | 600 | 1.2 | -0.005em |
| H4 | SF Pro Text | 20/28 | 600 | 1.25 | 0 |
| Body Large | SF Pro Text | 18/28 | 400 | 1.55 | 0 |
| Body | SF Pro Text | 16/24 | 400 | 1.5 | 0 |
| Small | SF Pro Text | 14/20 | 400 | 1.45 | 0.01em |
| Caption | SF Pro Text | 12/16 | 500 | 1.35 | 0.02em |
| Mono | SF Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: native Apple means platform-native, never web-port.
...
- **Photo style**: lifestyle + product
- **Illustration style**: SF Symbols icons
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-apple-hig
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base apple-hig`.
