...
> Vibe: Modern brutalism. Bold borders, vivid flat colors, hard shadows, geometric shapes.

> **Source**: https://open-design.ai/plugins/systems/example-neobrutalism
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download neobrutalism`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug neobrutalism`.
...
This system commits to bold playful. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#000000`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#ff5722`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffeb3b`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#000000`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#fff9c4`): Hover, disabled, inactive.

### Semantic
- **Success** (`#4caf50`): Confirmations, positive deltas.
- **Warning** (`#ff9800`): Caution, recoverable errors.
- **Danger** (`#f44336`): Destructive actions, errors, critical alerts.
- **Info** (`#2196f3`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#000000`): For optional surfaces.
- **Dark ink** (`#ffeb3b`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Archivo Black | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Space Grotesk | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Space Grotesk | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Space Grotesk | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Space Grotesk | 20/28 | 600 | 1.25 | 0 |
| Body Large | Space Grotesk | 18/28 | 400 | 1.55 | 0 |
| Body | Space Grotesk | 16/24 | 400 | 1.5 | 0 |
| Small | Space Grotesk | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Space Grotesk | 12/16 | 500 | 1.35 | 0.02em |
...
4. Match the system's vibe: bold playful means thick borders, vivid colors.
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-neobrutalism
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base neobrutalism`.
