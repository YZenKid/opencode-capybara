...
> Vibe: shadcn/ui. CSS variables, neutral palette, accessible, Radix primitives, Geist/Inter.

> **Source**: https://open-design.ai/plugins/systems/example-shadcn
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download shadcn`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug shadcn`.

---

## 1. Visual Theme & Atmosphere

shadcn's pragmatic discipline: tokens you own, components you copy, no theme lock-in.

This system commits to neutral pragmatic. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#0a0a0a`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#171717`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffffff`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#737373`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#fafafa`): Hover, disabled, inactive.

### Semantic
- **Success** (`#16a34a`): Confirmations, positive deltas.
- **Warning** (`#f59e0b`): Caution, recoverable errors.
- **Danger** (`#dc2626`): Destructive actions, errors, critical alerts.
- **Info** (`#2563eb`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#0a0a0a`): For toggleable surfaces.
- **Dark ink** (`#fafafa`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Geist / Inter | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Geist / Inter | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Geist / Inter | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Geist / Inter | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Geist / Inter | 20/28 | 600 | 1.25 | 0 |
| Body Large | Geist / Inter | 18/28 | 400 | 1.55 | 0 |
| Body | Geist / Inter | 16/24 | 400 | 1.5 | 0 |
| Small | Geist / Inter | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Geist / Inter | 12/16 | 500 | 1.35 | 0.02em |
| Mono | Geist Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: neutral pragmatic means Radix + Tailwind, no decoration.
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-shadcn
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base shadcn`.
