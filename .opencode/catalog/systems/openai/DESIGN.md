...
> Vibe: OpenAI. Deep teal-black ground, generous whitespace, editorial serif headlines, mono details.

> **Source**: https://open-design.ai/plugins/systems/example-openai
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download openai`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug openai`.

---

## 1. Visual Theme & Atmosphere

OpenAI's editorial discipline: serif for headlines, mono for tokens, deep teal as accent only.

This system commits to editorial AI. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#000000`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#10a37f`): Action color, focus, primary CTA, selected state.
- **Surface** (`#ffffff`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#6e6e80`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#f9f9f9`): Hover, disabled, inactive.

### Semantic
- **Success** (`#10a37f`): Confirmations, positive deltas.
- **Warning** (`#c9a227`): Caution, recoverable errors.
- **Danger** (`#ef4146`): Destructive actions, errors, critical alerts.
- **Info** (`#3a82f7`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#000000`): For primary surfaces.
- **Dark ink** (`#ffffff`): Primary text on dark ground.

## 3. Typography Scale

| Role | Family | Size | Weight | Line-height | Letter-spacing |
|---|---|---|---|---|---|
| Display | Charter / Georgia | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Charter / Source Serif | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Charter / Source Serif | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Charter / Source Serif | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Charter / Source Serif | 20/28 | 600 | 1.25 | 0 |
| Body Large | Charter / Source Serif | 18/28 | 400 | 1.55 | 0 |
| Body | Charter / Source Serif | 16/24 | 400 | 1.5 | 0 |
| Small | Charter / Source Serif | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Charter / Source Serif | 12/16 | 500 | 1.35 | 0.02em |
| Mono | Berkeley Mono | 14/20 | 400 | 1.5 | 0 |
...
4. Match the system's vibe: editorial AI means serif headlines, mono details.
...
- **Photo style**: abstract / generative
- **Illustration style**: geometric minimal
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-openai
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base openai`.
