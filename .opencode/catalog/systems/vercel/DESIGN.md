...
> Vibe: Near-monochrome black/white. Geist sans + Geist Mono. Geometric grid. Ultra-minimal.

> **Source**: https://open-design.ai/plugins/systems/example-vercel
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download vercel`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug vercel`.

---

## 1. Visual Theme & Atmosphere

Vercel's near-monochrome discipline: chrome is absent unless necessary, geometry carries hierarchy.

This system commits to near-monochrome. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#000000`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#0070f3`): Action color, focus, primary CTA, selected state.
...
### Semantic
- **Success** (`#0070f3`): Confirmations, positive deltas.
- **Warning** (`#f5a623`): Caution, recoverable errors.
- **Danger** (`#ee0000`): Destructive actions, errors, critical alerts.
- **Info** (`#0070f3`): Tips, non-blocking notices.
...
|---|---|---|---|---|---|
| Display | Geist | 56/64 | 700 | 1.05 | -0.02em |
| H1 | Geist | 40/48 | 700 | 1.1 | -0.015em |
| H2 | Geist | 32/40 | 700 | 1.15 | -0.01em |
| H3 | Geist | 24/32 | 600 | 1.2 | -0.005em |
| H4 | Geist | 20/28 | 600 | 1.25 | 0 |
| Body Large | Geist | 18/28 | 400 | 1.55 | 0 |
| Body | Geist | 16/24 | 400 | 1.5 | 0 |
| Small | Geist | 14/20 | 400 | 1.45 | 0.01em |
| Caption | Geist | 12/16 | 500 | 1.35 | 0.02em |
...
4. Match the system's vibe: near-monochrome means near-zero chrome.
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-vercel
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base vercel`.
