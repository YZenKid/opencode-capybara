...
> Vibe: Supabase. Dark emerald, code-first, technical density, generous line height.

> **Source**: https://open-design.ai/plugins/systems/example-supabase
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download supabase`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug supabase`.

---

## 1. Visual Theme & Atmosphere

Supabase's code-first discipline: emerald accent, generous line-height, technical density.

This system commits to code-first dark. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#1c1c1c`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#3ecf8e`): Action color, focus, primary CTA, selected state.
- **Surface** (`#f8f9fa`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#6b7280`): Secondary text, borders, dividers, low-emphasis fills.
- **Subtle** (`#e5e7eb`): Hover, disabled, inactive.

### Semantic
- **Success** (`#3ecf8e`): Confirmations, positive deltas.
- **Warning** (`#f59e0b`): Caution, recoverable errors.
- **Danger** (`#ef4444`): Destructive actions, errors, critical alerts.
- **Info** (`#3ecf8e`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#1c1c1c`): For primary surfaces.
- **Dark ink** (`#f8f9fa`): Primary text on dark ground.
...
4. Match the system's vibe: code-first dark means emerald accent, code-native.
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-supabase
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base supabase`.
