...
> Vibe: Perplexity. Deep-dark canvas, sharp typography, single violet accent, citation-first.

> **Source**: https://open-design.ai/plugins/systems/example-perplexity
> **License**: Apache-2.0
> **Indexed by**: `python3 ~/.config/opencode/scripts/design-source-importer.py --download perplexity`
> **Status**: downloaded (full content). For live refresh: `--refresh --slug perplexity`.

---

## 1. Visual Theme & Atmosphere

Perplexity's sharp-dark discipline: near-black canvas, single violet accent, sharp typography.

This system commits to sharp dark. It is **not** a generic modern-clean aesthetic; the rules below are concrete and rejectable.

## 2. Color Palette & Roles

### Primary
- **Ink** (`#ffffff`): Primary text, dark surfaces, structural strokes.
- **Accent** (`#8b5cf6`): Action color, focus, primary CTA, selected state.
- **Surface** (`#0a0a0a`): Light canvas for content blocks; cards, panels, sheets.

### Secondary
- **Muted** (`#a1a1aa`): Secondary text, borders, dividers, low-emphasis fills.
...
- **Info** (`#8b5cf6`): Tips, non-blocking notices.

### Dark variants (when applicable)
- **Dark ground** (`#0a0a0a`): For primary surfaces.
...
4. Match the system's vibe: sharp dark means citation-first, single accent.
...
- **Catalog source**: https://open-design.ai/plugins/systems/example-perplexity
- **License**: Apache-2.0
...
> Only present in forks via `python3 ~/.config/opencode/scripts/design-system-fork.py --base perplexity`.
