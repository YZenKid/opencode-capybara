...
- Transcript evaluator saat ini memakai normalized event sequence fixtures, belum parser otomatis untuk transcript mentah dari seluruh tool trace/runtime log.
