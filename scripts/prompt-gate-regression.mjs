...
const checks = [
  ...
  {
    file: "README.md",
    name: "support tooling onboarding docs gate",
    mustInclude: [
      "npm run setup:tools",
      "npm run doctor",
      "Support tooling",
      ...
      "support tooling stays optional",
    ],
    mustNotInclude: [
      "hidden postinstall",
    ],
  ...
  {
    file: "AGENTS.md",
    name: "support tooling policy gate",
    mustInclude: [
      "Keep shell command usage explicit and reviewable",
      "Use Caveman guidance as an optional support utility",
    ],
     mustNotInclude: [["R", "TK"].join(""), ["r", "tk"].join("")],
  },
  {
